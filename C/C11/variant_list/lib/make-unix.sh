...
gcc -std=c11 -fPIC -c -o lib$NAME.o lib$NAME.c
...
gcc -shared -Wl,-soname,lib$NAME.so.0 -o lib$NAME.so.0 lib$NAME.o -lm
ln -sf lib$NAME.so.0 lib$NAME.so


echo "Make-ing static executable..."
gcc -std=c11 -static -o $NAME-static $NAME.c -L. -l$NAME -lm
